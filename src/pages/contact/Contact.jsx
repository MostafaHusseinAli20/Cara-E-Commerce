          ...
          <div className="row ">
            ...
            <div className="col-lg-6 col-sm-12 getInTouch">
              ...
              <div className="d-flex">
                <RiBuilding4Line className="mt-2 fs-5 text-light" />
                <p className="mt-2 ms-3">
                  562 Wellingtion Road, Street 32. San Fransisco
                </p>
              </div>
              <div className="d-flex">
                <BiMessageSquareDetail className="mt-2 fs-5 text-light" />
                <p className="mt-1 ms-3"> contact@example.com </p>
              </div>
              <div className="d-flex">
                <MdOutlinePhoneInTalk className="mt-2 fs-5 text-light" />
                <p className="mt-1 ms-3"> +0123456789 (+91) </p>
              </div>
              <div className="d-flex">
                <CiClock2 className="mt-2 fs-5 text-light" />
